    ...
    <div className="container mx-auto py-8">
      ...
      {!extracted ? (
        <div className="mb-6 rounded-lg border bg-card p-4">
          <div className="font-medium">Nu avem inca datele din anunt.</div>
          <div className="mt-2 space-y-2 text-sm text-muted-foreground">
            <p>1) Daca rulezi pe productie, seteaza variabilele si redeploy:</p>
            <ul className="list-disc pl-5">
              <li>
                <code>ALLOW_SERVER_SCRAPE=true</code>
              </li>
              <li>
                <code>SERVER_WHITELIST</code> (ex: imobiliare.ro, olx.ro, storia.ro)
              </li>
            </ul>
            <p>2) Poti incerca din nou cu butonul &quot;Refresh&quot;.</p>
            <p>
              Daca server-scrape e dezactivat, foloseste extensia sau bookmarklet-ul pentru a{" "}
              trimite datele in endpoint:
            </p>
            <p>
              <code>/api/analyze/client-push</code>
            </p>
          </div>
        </div>
      ) : null}
