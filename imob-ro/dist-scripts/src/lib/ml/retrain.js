...
async function uploadToS3IfConfigured(filePath, key) {
    ...
    try {
        ...
        const cmd = new PutObjectCommand({ Bucket: process.env.S3_BUCKET, Key: key, Body: body, ContentType: "application/json" });
...
exports.default = { tryTrainGBM, saveArtifact, uploadToS3IfConfigured, updateCacheIfConfigured, artifactName };
