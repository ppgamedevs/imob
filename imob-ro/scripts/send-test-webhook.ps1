...
# Usage: .\send-test-webhook.ps1 -url "http://localhost:3000/api/webhook" -eventType "checkout.session.completed"
param(
...
Write-Host "Sending test webhook to $url with event $eventType"
